...
import com.example.enhancer.config.jwt.CustomTokenEnhancer;
import com.example.enhancer.config.jwt.CustomerAccessTokenConverter;
import com.example.enhancer.serviceImpl.UserDetailServiceImpl;
...
public class OAuthServerConfig {
    ...
    protected static class AuthorizationServerConfiguration extends AuthorizationServerConfigurerAdapter {
        ...
        public JwtAccessTokenConverter jwtAccessTokenConverter() {
            ...
            //设置自定义accessToken转换器，其中添加了自定义消息
