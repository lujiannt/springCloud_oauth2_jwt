package com.example.jwt2.serviceImpl;

import com.example.jwt2.entity.Role;
import com.example.jwt2.mapper.RoleMapper;
import com.example.jwt2.mapper.UserMapper;
...
public class UserDetailServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String userName) throws UsernameNotFoundException {
        com.example.jwt2.entity.User user = userMapper.selectUserByName(userName);
        if (user == null) {
